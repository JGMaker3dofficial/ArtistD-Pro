...
#define TOOL_OFFSET_CN              "挤出头偏移"
#define MOTOR_SETTINGS_CN						"电机设置"
...
#define FULL_CONTROL_CN	              "单头模式"
#define AUTO_PARK_CN		              "双头模式"
#define DUPLICATION_CN	              "复制模式"
#define MIRRORED_CN		                "镜像模式"
#define EEPROM_SETTINGS_CN            "参数设置"
#define EEPROM_SETTINGS_TITLE_CN      "参数设置"
#define EEPROM_SETTINGS_REVERT_CN     "使用配置文件默认参数"
#define EEPROM_REVERT_TIPS_CN         "是否使用配置文件默认参数?"

#define TOOL_OFFSET_TITLE_CN    "挤出头偏移"
#define TOOL_X_OFSSET_CN        "X2偏移"
#define TOOL_Y_OFSSET_CN        "Y2偏移"
#define TOOL_Z_OFSSET_CN        "Z2偏移"

#define MOTOR_CONF_TITLE_CN           "电机设置"
#define X_STEPS_CN                    "X轴脉冲"
#define Y_STEPS_CN                    "Y轴脉冲"
#define Z_STEPS_CN                    "Z轴脉冲"
#define E_STEPS_CN                    "E轴脉冲"
